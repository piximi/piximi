...
// const imagesT1: V11ImageObject[] = [];
// const initialImages = initialState.annotator.images;
// const annotationsT1: V11AnnotationObject[] = [];
...
//       colors: undefined as unknown as V11ImageObject["colors"],
//     } as V11ImageObject;
//     imagesT1.push(finalImage);
//     for (const annotation of image.annotations) {
//       const { mask, boundingBox, ...buildAnn } = annotation;
...
//   let newAnnotations: V11AnnotationObject[];
//   let newKinds: Kind[];
...
//     );
//     newAnnotations = deserializedCOCO.newAnnotations.map((ann) => ({
//       ...ann,
...
//       (
//         entities: EntityState<V11AnnotationObject | V11ImageObject, string>,
//         thing,
//       ) => {
...
//     const thingsT2 = imagesT1.reduce(
//       (
//         entities: EntityState<AnnotationObject | V11ImageObject, string>,
//         thing,
//       ) => {
//         entities.ids.push(thing.id);
//         entities.entities[thing.id] = thing;
