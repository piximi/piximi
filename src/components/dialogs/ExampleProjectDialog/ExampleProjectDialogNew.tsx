...
import { ExampleProjectCardNew } from "components/cards/ExampleProjectCard/ExampleProjectCardNew";
...
export const ExampleProjectDialogNew = (props: ExampleProjectDialogProps) => {
