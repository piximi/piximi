export const StartNewProject = `Begin a new project in PIXIMI.`;
...
export const Documentation = "Open the Piximi Documentation in a new tab";

export const ProjectName = "Change the project name";
...
export const GridZoom = "Adjust the size of the displayed imaages";

export const OpenProject = `To open a saved project click 'Open project' in the Open menu on the left toolbar.
      Select a .zip or .zarr file that was downloaded when saving an earlier project.
      `;

export const SaveProject = `Save all images and assigned categories by clicking on "Save project file" in the Save menu on the left toolbar.
...
export const OpenImage = `In the left menu, select "Open image" to upload images from your local machine.
Select one or multiple image files to open.

Alternatively, drag and drop the desired image files directly onto the gallery.`;

export const OpenMenu = `From the **Open** Menu you can open=
...
export const KindTabs = `Click on the tabs to view the different **Kinds** of objects in your project.\n
Tab Functions
...
export const AddKindTab = `Create a new **Kind** or re-open one that was previously minimized.`;

export const EditKind = `Edit the display name of the *Kind*`;

export const DeleteKind = `Delete this *Kind*, associated objects and categories will also be deleted`;

export const CreateKind = `Create a new *Kind*`;
...
export const SaveClassificationModel = `Save the configuration and weight of the current classification model.
...
export const LoadClassificationModel = `Upload a previusoly trained classification model from the ***.json** and ***.weights.bin** files.`;
...
export const LearningRate = `The learning rate is a value that determines by how much the model updates its internal parameters in response to the loss function.`;

export const LossFunction = `The loss function calculates how well a model has performed by comparing the prediction made by the model and what was expected.
...
export const Epochs = `An epoch is a measure of how many times the entire training subset is studied by the deep learning model.
...
export const DeleteAllCategories = `Delete all categories belinging to the active *Kind*.\n
*Associated objects well be recategorized as 'Unknown'*`;

export const Settings = `Open the application settings.`;

export const SendFeedback = `Report issues or send feedback about Piximi to the Github Repository`;

export const FilterImageGrid = `Filter the images in the image grid by 'Category' or Training 'Partition'.`;

export const GridItemInfo = `View details of selected items in the Image Grid`;

export const NavigateImageViewer = `Navigate to the Image Viewer to inspect and work with the selected images and objects.`;

export const NavigateMeasurements = `Navigate to the Measurements view to perform measurements on the project data and visualize results.`;

export const CropOptions = `Cropping effectively creates multiple training samples from a single image.\n
...
export const PixelIntensityRescale = `
...
export const DataShuffling = `Shuffling the data can help reduce bias during training and improve model accuracy.\n
This is expecially true when cropping the images prior to training.
      `;

export const ModelArchitecture = `Model architecture refers to the algorithm will our model use to compute its answers.`;
